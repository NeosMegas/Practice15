...
namespace Practice15
{
    internal class Program
    {
        ...
        {
            Console.WriteLine("Программа выводит цифры от 1 до 3 в трёх разных соответствующих потоках. Первый поток выводит красную единицу, второй - зелёную двойку, третий - синюю тройку.\n");
        ...
        {
            Console_Color(0);
            Console.WriteLine("Вывод с помощью async: начало...");
        ...
        {
            Console_Color(0);
            Console.WriteLine("Вывод с помощью Task: начало...");
        ...
        {
            Console_Color(0);
            Console.WriteLine("Вывод с помощью Thread: начало...");
